 ...
 * com.company.public_.appreservas.public_.organizador.Organizador}-interface
...
public interface GeneratedOrganizador {
     ...
     */
    IntField<Organizador, Integer> ORGANIZADORID = IntField.create(
     ...
     */
    StringField<Organizador, String> NOME = StringField.create(
        Identifier.NOME,
        Organizador::getNome,
        Organizador::setNome,
        TypeMapper.identity(),
     ...
     */
    StringField<Organizador, String> CONTACTO = StringField.create(
        Identifier.CONTACTO,
     ...
     */
    IntForeignKeyField<Organizador, Integer, Utilizador> USERID = IntForeignKeyField.create(
        Identifier.USERID,
     ...
     * appReservas.public.organizador.organizadorid.
     * 
     ...
     * database column appReservas.public.organizador.nome.
     * 
     ...
     * to the database column appReservas.public.organizador.contacto.
     * 
     ...
     * the database column appReservas.public.organizador.userid.
     * 
     ...
     * the database column appReservas.public.organizador.contacto.
     * 
     ...
     * database column appReservas.public.organizador.userid.
     * 
