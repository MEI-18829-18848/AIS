 ...
 * com.company.public_.appreservas.public_.evento.Evento}-interface representing
...
public interface GeneratedEvento {
     ...
     */
    IntField<Evento, Integer> EVENTOID = IntField.create(
        Identifier.EVENTOID,
        Evento::getEventoid,
        Evento::setEventoid,
     ...
     */
    IntForeignKeyField<Evento, Integer, Sala> SALAID = IntForeignKeyField.create(
        Identifier.SALAID,
        Evento::getSalaid,
        Evento::setSalaid,
        Sala.SALAID,
     ...
     */
    IntForeignKeyField<Evento, Integer, Organizador> ORGANIZADORID = IntForeignKeyField.create(
     ...
     */
    StringField<Evento, String> NOME = StringField.create(
        Identifier.NOME,
     ...
     */
    StringField<Evento, String> DESCRICAO = StringField.create(
     ...
     */
    StringField<Evento, String> CATEGORIA = StringField.create(
     ...
     */
    StringField<Evento, String> IMDBID = StringField.create(
        Identifier.IMDBID,
     ...
     * the database column appReservas.public.evento.eventoid.
     * 
     ...
     * database column appReservas.public.evento.salaid.
     * 
     ...
     * appReservas.public.evento.organizadorid.
     * 
     ...
     * database column appReservas.public.evento.nome.
     * 
     ...
     * the database column appReservas.public.evento.descricao.
     * 
     ...
     * the database column appReservas.public.evento.categoria.
     * 
     ...
     * database column appReservas.public.evento.imdbid.
     * 
     ...
     * database column appReservas.public.evento.eventoid.
     * 
     ...
     * column appReservas.public.evento.nome.
     * 
     ...
     * database column appReservas.public.evento.descricao.
     * 
     ...
     * database column appReservas.public.evento.categoria.
     * 
