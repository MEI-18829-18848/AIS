package com.company.public_.appreservas.public_.lugar.generated;

import com.company.public_.appreservas.public_.lugar.Lugar;
 ...
 * com.company.public_.appreservas.public_.lugar.Lugar}-interface representing
...
public interface GeneratedLugar {
     ...
     */
    IntField<Lugar, Integer> LUGARID = IntField.create(
        Identifier.LUGARID,
        Lugar::getLugarid,
        Lugar::setLugarid,
     ...
     */
    IntForeignKeyField<Lugar, Integer, Sala> SALAID = IntForeignKeyField.create(
        Identifier.SALAID,
        Lugar::getSalaid,
        Lugar::setSalaid,
        Sala.SALAID,
     ...
     */
    StringField<Lugar, String> NOME = StringField.create(
        Identifier.NOME,
     ...
     */
    ComparableField<Lugar, Integer, Integer> QUANTIDADE = ComparableField.create(
     ...
     */
    ComparableField<Lugar, BigDecimal, BigDecimal> VALOR = ComparableField.create(
        Identifier.VALOR,
     ...
     * database column appReservas.public.lugar.lugarid.
     * 
     ...
     * database column appReservas.public.lugar.salaid.
     * 
     ...
     * database column appReservas.public.lugar.nome.
     * 
     ...
     * the database column appReservas.public.lugar.quantidade.
     * 
     ...
     * database column appReservas.public.lugar.valor.
     * 
     ...
     * column appReservas.public.lugar.nome.
     * 
     ...
     * column appReservas.public.lugar.valor.
     * 
