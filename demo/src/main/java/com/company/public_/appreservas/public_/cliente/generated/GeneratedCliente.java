 ...
 * com.company.public_.appreservas.public_.cliente.Cliente}-interface
 * representing entities of the {@code cliente}-table in the database.
 * <p>
...
public interface GeneratedCliente {
     ...
     */
    IntField<Cliente, Integer> CLIENTEID = IntField.create(
     ...
     */
    IntForeignKeyField<Cliente, Integer, Utilizador> USERID = IntForeignKeyField.create(
        Identifier.USERID,
        Cliente::getUserid,
        Cliente::setUserid,
     ...
     */
    StringField<Cliente, String> NOME = StringField.create(
        Identifier.NOME,
        Cliente::getNome,
        Cliente::setNome,
        TypeMapper.identity(),
     ...
     */
    ComparableField<Cliente, Integer, Integer> TELEMOVEL = ComparableField.create(
     ...
     */
    StringField<Cliente, String> EMAIL = StringField.create(
        Identifier.EMAIL,
     ...
     */
    ComparableField<Cliente, Integer, Integer> NIF = ComparableField.create(
        Identifier.NIF,
     ...
     * the database column appReservas.public.cliente.clienteid.
     * 
     ...
     * database column appReservas.public.cliente.userid.
     * 
     ...
     * database column appReservas.public.cliente.nome.
     * 
     ...
     * the database column appReservas.public.cliente.telemovel.
     * 
     ...
     * database column appReservas.public.cliente.email.
     * 
     ...
     * database column appReservas.public.cliente.nif.
     * 
     ...
     * column appReservas.public.cliente.nome.
     * 
     ...
     * column appReservas.public.cliente.nif.
     * 
