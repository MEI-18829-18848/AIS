package com.company.public_.appreservas.public_.reserva.generated;

import com.company.public_.appreservas.public_.cliente.Cliente;
import com.company.public_.appreservas.public_.reserva.Reserva;
 ...
 * com.company.public_.appreservas.public_.reserva.Reserva}-interface
 * representing entities of the {@code reserva}-table in the database.
 * <p>
...
public interface GeneratedReserva {
     ...
     */
    IntField<Reserva, Integer> RESERVAID = IntField.create(
     ...
     */
    IntForeignKeyField<Reserva, Integer, Sessao> SESSAOID = IntForeignKeyField.create(
        Identifier.SESSAOID,
        Reserva::getSessaoid,
        Reserva::setSessaoid,
        Sessao.SESSAOID,
     ...
     */
    IntForeignKeyField<Reserva, Integer, Cliente> CLIENTEID = IntForeignKeyField.create(
     ...
     */
    ComparableField<Reserva, BigDecimal, BigDecimal> CUSTO = ComparableField.create(
        Identifier.CUSTO,
     ...
     * the database column appReservas.public.reserva.reservaid.
     * 
     ...
     * the database column appReservas.public.reserva.sessaoid.
     * 
     ...
     * the database column appReservas.public.reserva.clienteid.
     * 
     ...
     * database column appReservas.public.reserva.custo.
     * 
     ...
     * database column appReservas.public.reserva.sessaoid.
     * 
