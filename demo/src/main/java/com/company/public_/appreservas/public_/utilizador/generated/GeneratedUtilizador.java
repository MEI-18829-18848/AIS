 ...
 * com.company.public_.appreservas.public_.utilizador.Utilizador}-interface
...
public interface GeneratedUtilizador {
     ...
     */
    IntField<Utilizador, Integer> UTILIZADORID = IntField.create(
     ...
     */
    StringField<Utilizador, String> ROLE = StringField.create(
        Identifier.ROLE,
        Utilizador::getRole,
        Utilizador::setRole,
        TypeMapper.identity(),
