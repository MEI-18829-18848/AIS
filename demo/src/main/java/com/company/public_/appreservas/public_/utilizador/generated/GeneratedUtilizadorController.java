...
public abstract class GeneratedUtilizadorController {
    ...
    public void create(
        ...
        final Persister<Utilizador> persister = manager.persister();
        final Utilizador utilizador = manager.create()
            .setUtilizadorid(createBody.getUtilizadorid())
    ...
    public void update(
        ...
        final Updater<Utilizador> updater = manager.updater(excluded);
