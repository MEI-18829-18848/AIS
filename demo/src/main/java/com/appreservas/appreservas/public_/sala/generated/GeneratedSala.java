 ...
 * com.appreservas.appreservas.public_.sala.Sala}-interface representing
...
public interface GeneratedSala {
    ...
    /**
     * This Field corresponds to the {@link Sala} field that can be obtained
     * using the {@link Sala#getLocalizaO()} method.
     */
    StringField<Sala, String> LOCALIZA_O = DatastoreFields.createStringField(
        Identifier.LOCALIZA_O,
        o -> OptionalUtil.unwrap(o.getLocalizaO()),
        Sala::setLocalizaO,
        TypeMapper.identity(),
        false
    );
     ...
     */
    BooleanField<Sala, Boolean> LUAGRESMARCADOS = DatastoreFields.createBooleanField(
    ...
    /**
     * Returns the localizaO of this Sala. The localizaO field corresponds to
     * the database column appreservas.public.sala.localiza��o.
     * 
     * @return the localizaO of this Sala
     */
    Optional<String> getLocalizaO();
    ...
    /**
     * Sets the localizaO of this Sala. The localizaO field corresponds to the
     * database column appreservas.public.sala.localiza��o.
     * 
     * @param localizaO to set of this Sala
     * @return          this Sala instance
     */
    Sala setLocalizaO(String localizaO);
