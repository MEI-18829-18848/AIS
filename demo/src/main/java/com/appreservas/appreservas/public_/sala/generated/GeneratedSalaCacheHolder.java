...
import com.appreservas.appreservas.public_.sala.SalaEntityStoreSerializerImpl;
...
public final class GeneratedSalaCacheHolder implements EntityStoreHolder<Sala> {
    ...
    private final OfString fieldLocalizaOCache;
    private final OfBoolean fieldLuagresmarcadosCache;
    ...
    public GeneratedSalaCacheHolder(
            ...
            OfString fieldLocalizaOCache,
            OfBoolean fieldLuagresmarcadosCache,
        ...
        this.fieldLocalizaOCache       = requireNonNull(fieldLocalizaOCache);
        this.fieldLuagresmarcadosCache = requireNonNull(fieldLuagresmarcadosCache);
    ...
    public <CACHE extends FieldCache<CACHE>> CACHE getFieldCache(ColumnIdentifier<Sala> columnId) {
        if (columnId instanceof Sala.Identifier) {
            ...
            switch (_id) {
                ...
                case LOCALIZA_O      : return (CACHE) fieldLocalizaOCache;
                case LUAGRESMARCADOS : return (CACHE) fieldLuagresmarcadosCache;
            ...
            switch (_colName) {
                case "salaid"          : return (CACHE) fieldSalaidCache;
                case "nome"            : return (CACHE) fieldNomeCache;
                case "localiza��o"     : return (CACHE) fieldLocalizaOCache;
                case "luagresmarcados" : return (CACHE) fieldLuagresmarcadosCache;
                case "lotacao"         : return (CACHE) fieldLotacaoCache;
                default : {
                    throw new UnsupportedOperationException(
    ...
    public static CompletableFuture<GeneratedSalaCacheHolder> reload(StreamSupplierComponent streamSupplier, ExecutorService executor) {
        return reload(DataStoreHolderUtil.buildEntityStore(
            ...
            TableIdentifier.of("appreservas", "public", "sala")
        ), executor);
    }
    ...
    private EntityStoreHolder<Sala> wrapped() {
        ...
        final Map<ColumnLabel, FieldCache<?>> fieldCaches = Stream.<Tuple2<HasIdentifier<Sala>, FieldCache<?>>>of(
            ...
            Tuples.of(Sala.LOCALIZA_O,     fieldLocalizaOCache),
            Tuples.of(Sala.LUAGRESMARCADOS,fieldLuagresmarcadosCache),
    ...
    public static CompletableFuture<GeneratedSalaCacheHolder> reload(CompletableFuture<EntityStore<Sala>> entityStoreFuture, ExecutorService executor) {
        ...
        final CompletableFuture<FieldCache.OfString> fieldLocalizaOCacheFuture =
            DataStoreHolderUtil.buildStringCache(entityStoreFuture, executor, Sala.LOCALIZA_O, 0);
        
        final CompletableFuture<FieldCache.OfBoolean> fieldLuagresmarcadosCacheFuture =
            DataStoreHolderUtil.buildBooleanCache(entityStoreFuture, executor, Sala.LUAGRESMARCADOS, 0);
        ...
        return entityStoreFuture.thenApplyAsync(entityStore -> {
            try {
                return new GeneratedSalaCacheHolder(
                    ...
                    fieldLocalizaOCacheFuture.get(),
                    fieldLuagresmarcadosCacheFuture.get(),
    ...
    public void close() {
        ...
        fieldLocalizaOCache.close();
        fieldLuagresmarcadosCache.close();
    ...
    public Statistics getStatistics() {
        return StatisticsUtil.getStatistics(    
            ...
            Arrays.asList(
                ...
                Sala.Identifier.LOCALIZA_O,
                Sala.Identifier.LUAGRESMARCADOS,
